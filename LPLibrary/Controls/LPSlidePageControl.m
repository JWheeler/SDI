...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
		...
		[backgroundView setImage:[[UIImage imageNamed:@"sliderPageControlBg.png"] stretchableImageWithLeftCapWidth:10 topCapHeight:10]];
